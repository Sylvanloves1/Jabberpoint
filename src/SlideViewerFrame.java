...
public class SlideViewerFrame extends JFrame {
	...
	private static final String JABTITLE = JabberPoint.text("JABVERSION");
	...
	//Setup the GUI
	public void setupWindow(SlideViewerComponent slideViewerComponent, Presentation presentation, String title) {
		if (title.isEmpty()) {
			setTitle(JABTITLE);
		} else {
			setTitle(title);
